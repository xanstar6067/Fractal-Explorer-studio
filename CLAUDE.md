...
комплексная логистическая карта и физические модели (включая окна, численные проверки и сохранения):
