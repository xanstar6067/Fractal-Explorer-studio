...
При добавлении любого нового GPU/3D-режима или варианта шейдера включай его в общий дисковый кэш `Infrastructure/ShaderBytecodeCache.cs` через `AppPaths.ShaderCacheDirectory`. Ключ кэша должен учитывать исходник, точку входа и профиль компиляции; новый вариант должен участвовать в команде «Пересобрать шейдеры» на главной странице. Не храни скомпилированный байткод рядом с exe и не вводи отдельную папку кэша для каждого фрактала.
