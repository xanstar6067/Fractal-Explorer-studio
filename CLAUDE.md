...
| `Views/NewtonPaletteWindow.xaml` / `.xaml.cs` | Настройка цветов корней и палитр бассейнов Ньютона; вызывается из `NewtonPoolsWindow`, а с подписями корней, циклов, периодов или физических центров и без флажка градиента — из `BasinExplorerWindow`. |
