...
параметры формы, окраски и камеры доходят до шейдера, оба якоря вращения, луч через пиксель,
