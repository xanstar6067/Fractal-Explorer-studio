...
internal static partial class Program
{
    ...
    /// множество на чёрном фоне бассейна ∞, бледные широкие полосы sin(z), векторные поля с одним или концентрическими бассейнами,
    /// где яркость почти одинакова по всей плоскости, и системы с одним аттрактором, которые в палитре
    /// «Огонь» (так решено для точек бассейнов) остаются в тёмно-красном первом цвете. Новые точки сюда не добавлять — их нужно
    ...
    [
        ...
        "Basins-Secant / z³ − 2z + 2 · вещественный срез (Re x₀, Re x₁)",
        "Basins-RationalMap / Мак-Маллен z³ + c/z³: канторово множество окружностей",
        "Basins-RationalMap / z² + c/z² при c = −1/16: ковёр Серпинского",
        "Basins-GradientDescent / Розенброк · Adam",
    ];
