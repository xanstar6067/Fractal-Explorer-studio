...
public static class PresetManager
{
    ...
    public static IReadOnlyList<MandelbrotState> GetMandelbrotPresets(MandelbrotVariant variant) => variant switch
    {
        ...
        [
            ...
            M("Лоза", variant, 0.3855604675494107229386479028m, -0.1050451711526294339131097223m, 150m, 800, "Огонь", scale: 8),
            M("Спиральная Галактика", variant, -0.16070135m, 1.0375665m, 3000m, 600, "Ультрафиолет", scale: 10),
            ...
            M("Четверная Спираль", variant, -0.7746806106269039m, -0.1374168856037867m, 5000m, 1500, "Космос", scale: 10),
