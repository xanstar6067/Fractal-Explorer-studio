...
public static class FractalCatalog
{
    ...
    [
        ...
        Item(["Фракталы", "Трёхмерные фракталы"], "Горящий корабль 3D", "Трёхмерное продолжение «Горящего корабля» с отражением координат перед квадратичной итерацией. Плоский срез z = 0 совпадает с исходным фракталом.", Placeholder3D, Fractal3DCatalog.LaunchKey(Fractal3DKind.BurningShip)),
