...
public static class FractalCatalog
{
    ...
    [
        ...
        Item(["Динамические системы и хаос", "Аттракторы"], "Объёмные странные аттракторы", "Шесть систем непрерывного потока — Лоренц, Рёсслер, Томас, Халворсен, Айзава и Дадрас — как облака плотности с общей 3D-камерой, готовыми видами и настройками траектории.", Placeholder3D, Fractal3DCatalog.LaunchKey(Fractal3DKind.StrangeAttractor)),
