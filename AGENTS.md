...
луч через пиксель,
зонд расстояния до поверхности, отмена и сохранения (нужен Direct3D 11), `cloud` — облачные
