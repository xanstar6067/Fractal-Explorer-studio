...
`fractal3d` — шесть видов трёхмерных фракталов: дистанционные оценки на GPU не дают пустой кадр,
