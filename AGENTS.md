...
параметры формы, окраски и камеры доходят до шейдера, оба якоря вращения, плавная доводка колеса,
